...
namespace Okul_Programı
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            Form3 f3 = new Form3();
            f3.Show();
            foreach (ogretmen ogretmen3 in ogretmen.ogretmengetir())
            {
                f3.listBox1.Items.Add("Öğretmen Adı Soyadı :  " + ogretmen3.ogretmenadsoyadver());
                f3.listBox1.Items.Add("Öğretmen'in Girdiği Sınıf :  " + ogretmen3.ogretmengırsınıfver());
            }

            foreach (ogrenci ogrenci1 in ogrenci.ogrencigetir())
            {
                f3.listBox2.Items.Add("Öğrenci Adı Soyadı :  " + ogrenci1.ogrenciadsoyadver());
                f3.listBox2.Items.Add("Öğrenci'nin Okul Numarası :  " + ogrenci1.ogrenciokulnover());
                f3.listBox2.Items.Add("Öğrenci'nin Sınıfı :  " + ogrenci1.ogrencisınıfver());
            }
